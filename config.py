...
DEFAULTS = {
    ...
    # Дефолт 480 (8 минут) — нарочно НЕ кратно интервалу регистратора
    # email-zhkh (300с / 5 мин), чтобы два daemon'а на одной шаре редко
    # пересекались в момент чтения одного и того же xlsx.
    "poll_interval_sec": 480,
