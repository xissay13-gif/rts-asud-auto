"""
deadline.py — Расчёт срока отработки обращений ГИС ЖКХ.

Общий модуль: используется и при регистрации (P1, email-flow в ветке
email-zhkh — там shared/deadline.py), и при отписывании (P3, этот файл).
